...
class PersonalityConfig:
    ...
    def get_high_openness():
        return PersonalityConfig(
            name="high_openness",
            description="""You are a student with high openness who values creative, abstract, and unconventional ideas."""
        )
    ...
    def get_high_conscientiousness():
        return PersonalityConfig(
            ...
            description="""You are a student with high conscientiousness who values organization, precision, and academic discipline."""
        )
    ...
    def get_high_extraversion():
        return PersonalityConfig(
            ...
            description="""You are a student with high extraversion who values social energy, enthusiastic talk, and group collaboration."""
        )
    ...
    def get_high_agreeableness():
        return PersonalityConfig(
            ...
            description="""You are a student with high agreeableness who values social harmony, polite cooperation, and helping others."""
        )
    ...
    def get_high_neuroticism():
        return PersonalityConfig(
            ...
            description="""You are a student with high neuroticism who values risk awareness, constant reassurance, and academic caution."""
        ) 
